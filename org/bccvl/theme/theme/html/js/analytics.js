...
require(['jquery'], function($) {
    $(document).ready(function(){
        ...
        $('section.bccvl-datasetlist').on('click', '.datasets-list-entry .dataset-download-btn', function(){
            _gaq.push(['_trackEvent', 'Datasets Browse Interface', 'Apply Filters', 'Apply Filters Button Click']);
        });
        ...
        $('section.bccvl-datasetimport').on('click', '.bccvl-datasetimportform .import-dataset-btn', function(){
            ...
            _gaq.push(['_trackEvent', 'Datasets Import Interface', 'Dataset Import', label ]);
        });
        ...
        $('section.bccvl-datasetimport').on('click', 'button[type="submit"]', function(){
            var label = $(this).attr('id');
            _gaq.push(['_trackEvent', 'Datasets Import Interface', 'Dataset Upload Form Submit', label ]);
        });
        ...
        $('section.bccvl-knowledgebase').on('click', '.bccvl-kbsearchcontent a.title_link', function(){
            _gaq.push(['_trackEvent', 'Datasets Import Interface', 'Dataset Upload Form Submit', $(this).text() ]);
        });
        ...
        $('section.bccvl-new-sdm .bccvl-wizardtabs a[data-toggle="tab"]').on('shown', function(e){
            ...
            _gaq.push(['_trackEvent', 'New SDM tab change', $(e.target).text(), $(e.relatedTarget).text() ]);
        });
        $('section.bccvl-new-projection .bccvl-wizardtabs a[data-toggle="tab"]').on('shown', function(e){
            _gaq.push(['_trackEvent', 'New CCE tab change', $(e.target).text(), $(e.relatedTarget).text() ]);
        });
        $('section.bccvl-new-biodiverse .bccvl-wizardtabs a[data-toggle="tab"]').on('shown', function(e){
            _gaq.push(['_trackEvent', 'New Biodiverse tab change', $(e.target).text(), $(e.relatedTarget).text() ]);
        });
        $('section.bccvl-new-speciestrait .bccvl-wizardtabs a[data-toggle="tab"]').on('shown', function(e){
            _gaq.push(['_trackEvent', 'New STM tab change', $(e.target).text(), $(e.relatedTarget).text() ]);
        });
        $('section.bccvl-new-ensemble .bccvl-wizardtabs a[data-toggle="tab"]').on('shown', function(e){
            _gaq.push(['_trackEvent', 'New Ensemble tab change', $(e.target).text(), $(e.relatedTarget).text() ]);
        });

        $('section.bccvl-new-sdm').on('click', 'button.bccvllinks-experiment-start', function(){
             _gaq.push(['_trackEvent', 'New Experiment Submit', 'SDM' ]);
        });
        $('section.bccvl-new-projection').on('click', 'button.bccvllinks-experiment-start', function(){
             _gaq.push(['_trackEvent', 'New Experiment Submit', 'Climate Change Experiment' ]);
        });
        $('section.bccvl-new-biodiverse').on('click', 'button.bccvllinks-experiment-start', function(){
             _gaq.push(['_trackEvent', 'New Experiment Submit', 'Biodiverse' ]);
        });
        $('section.bccvl-new-speciestrait').on('click', 'button.bccvllinks-experiment-start', function(){
             _gaq.push(['_trackEvent', 'New Experiment Submit', 'Species Trait Modelling' ]);
        });
        $('section.bccvl-new-ensemble').on('click', 'button.bccvllinks-experiment-start', function(){
             _gaq.push(['_trackEvent', 'New Experiment Submit', 'Ensemble' ]);
        });

        // Validation events for new experiment tabs
        $('section.bccvl-flashmessages.bccvl-new-sdm').on('validationError', function(){
             _gaq.push(['_trackEvent', 'New Experiment Validation Error', 'SDM' ]);
        });
        $('section.bccvl-flashmessages.bccvl-new-projection').on('validationError', function(){
             _gaq.push(['_trackEvent', 'New Experiment Validation Error', 'Climate Change Experiment' ]);
        });
        $('section.bccvl-flashmessages.bccvl-new-biodiverse').on('validationError', function(){
             _gaq.push(['_trackEvent', 'New Experiment Validation Error', 'Biodiverse' ]);
        });
        $('section.bccvl-flashmessages.bccvl-new-speciestrait').on('validationError', function(){
             _gaq.push(['_trackEvent', 'New Experiment Validation Error', 'Species Trait Modelling' ]);
        });
        $('section.bccvl-flashmessages.bccvl-new-ensemble').on('validationError', function(){
             _gaq.push(['_trackEvent', 'New Experiment Validation Error', 'Ensemble' ]);
        });
