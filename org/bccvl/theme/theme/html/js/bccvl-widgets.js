    ...
    function($) {
        ...
        function selectable($elements) {
            $elements.click(function(event) {
                // get parent row div
                var $row = $(event.target).closest('div.datasets-list-entry');
                ...
                $row.parent().find('div.datasets-list-entry:has(input:checked)').addClass("ui-selected");
                $row.parent().find('div.datasets-list-entry:has(input:not(:checked))').removeClass("ui-selected");
            });
        };
